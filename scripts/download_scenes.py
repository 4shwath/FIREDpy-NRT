...
def download_product(product, output_file, output_directory):
    '''
...
def extract_tar_product(output_directory, tar_file):
    '''
       ...
       # Create directories for saving the images or the footprints
        ...
        if config.download_scenes:
            ...
            for i in range(len(products)):
                ...
                download_product(product, output_file, output_directory)
                extract_zip_product(output_directory, output_file)           
...
def main(event_id, satellite):
    ...
    """
    file_dir = os.path.join('/home/aramakrishnan/Documents/Firedpy/Fire_events')
